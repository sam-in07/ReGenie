                      ...
                      Row(
                        ...
                        children: [
                          StatCard(
                            ...
                            icon: Image.asset("assets/profiles/incri.png"),
                          ),
                          SizedBox(width: 3),
                          StatCard(
                            title: "Rank",
                            value: "#$rank",
                            icon: Image.asset("assets/profiles/prize.png"),
                          ),
                          SizedBox(width: 3),
                          StatCard(
                            title: "Badges",
                            value: challengesCompleted.toString(),
                            icon: Image.asset("assets/profiles/badge.png"),
                          ),
                        ],
                      ),
                      ...
                      GridView.count(
                        ...
                        children: const [
                          ...
                          AchievementCard(
                            title: "Eco Warrior",
                            achieved: true,
                            imagePath: "assets/profiles/warriror.png",
                          ),
                          AchievementCard(
                            title: "Week Streak",
                            achieved: true,
                            imagePath: "assets/profiles/fire.png",
                          ),
                          AchievementCard(
                            title: "Plant Parent",
                            achieved: false,
                            imagePath: "assets/profiles/tree.png",
                          ),
                          AchievementCard(
                            title: "Eco Master",
                            achieved: false,
                            imagePath: "assets/profiles/master.png",
                          ),
                          AchievementCard(
                            title: "Zero Waste",
                            achieved: false,
                            imagePath: "assets/profiles/recycle.png",
                          ),
                        ],
                      ),
